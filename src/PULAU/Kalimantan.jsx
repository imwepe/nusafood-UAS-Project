...
const Kalimantan = () => {
  ...
  const Food = [
    {
      name: "Soto Banjar",
      description: `Soto Banjar adalah salah satu masakan tradisional dari Kalimantan selatan, kususnya Banjarmasin. Soto Banjar merupakan salah satu kuliner yang terkenal di Indonesia. Berbeda dengan soto lainnya di Indonesia, soto ini memiliki keunikan dalam penyajian dan cita rasanya.`,
      backgroundUrl:
        "https://www.masakapahariini.com/wp-content/uploads/2019/06/5.jpg",
    },
    {
      name: "Kerupuk Basah",
      description: `Kerupuk Basah adalah kuliner daerah khas Kalimantan Barat dan Kalimantan Tengah. panganan ini berbahan dasar ikan sungai yang digiling kemudian dicampur tepung tapioka, serta bumbu-bumbu lain seperti bawang putih, merica, penyedap rasa, dan garam.`,
      backgroundUrl:
